...
import TableRow from './feedback-table-row';
...
export default function FeedBackPage() {
  ...
  const handleSelectAllClick = (event) => {
    if (event.target.checked) {
      const newSelecteds = feedback.map((n) => n.title);
            ...
            <Table sx={{ minWidth: 800 }}>
              <TableHead
                ...
                headLabel={[
                  ...
                  { id: 'date', label: 'Date' },          
                  { id: 'firstTime', label: 'First Time to Visit the Website' },
                  { id: 'reason', label: 'Reason to Visit Website' },
                  { id: 'found', label: 'Found Necessary Information' },                 
                  { id: 'userFriendly', label: 'Website UserFriendly?' },
              ...
              <TableBody>
                ...
                <TableEmptyRows
                  height={77}
                  emptyRows={emptyRows(page, rowsPerPage, feedback.length)}
                />
